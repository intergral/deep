...
import (
	...
	v11 "github.com/intergral/deep/pkg/deeppb/common/v1"
...
type Span struct {
	...
	Kind Span_SpanKind `protobuf:"varint,6,opt,name=kind,proto3,enum=deeppb.trace.v1.Span_SpanKind" json:"kind,omitempty"`
...
type Status struct {
	...
	// The status code.
	Code Status_StatusCode `protobuf:"varint,3,opt,name=code,proto3,enum=deeppb.trace.v1.Status_StatusCode" json:"code,omitempty"`
}
...
func init() {
	proto.RegisterEnum("deeppb.trace.v1.Span_SpanKind", Span_SpanKind_name, Span_SpanKind_value)
	proto.RegisterEnum("deeppb.trace.v1.Status_StatusCode", Status_StatusCode_name, Status_StatusCode_value)
	proto.RegisterType((*TracesData)(nil), "deeppb.trace.v1.TracesData")
	proto.RegisterType((*ResourceSpans)(nil), "deeppb.trace.v1.ResourceSpans")
	proto.RegisterType((*ScopeSpans)(nil), "deeppb.trace.v1.ScopeSpans")
	proto.RegisterType((*InstrumentationLibrarySpans)(nil), "deeppb.trace.v1.InstrumentationLibrarySpans")
	proto.RegisterType((*Span)(nil), "deeppb.trace.v1.Span")
	proto.RegisterType((*Span_Event)(nil), "deeppb.trace.v1.Span.Event")
	proto.RegisterType((*Span_Link)(nil), "deeppb.trace.v1.Span.Link")
	proto.RegisterType((*Status)(nil), "deeppb.trace.v1.Status")
}
