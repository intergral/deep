...
type PollRequest struct {
	...
	TsNanos     uint64       `protobuf:"fixed64,1,opt,name=ts_nanos,json=tsNanos,proto3" json:"ts_nanos,omitempty"`           //time message was sent, acts as message id (useful for tracing)
