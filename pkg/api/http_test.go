...
func TestEquality(t *testing.T) {
	assert.Equal(t, HeaderAccept, "Accept")
	assert.Equal(t, HeaderAcceptProtobuf, "application/protobuf")
}
...
func TestQuerierParseSearchRequest(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			r := httptest.NewRequest("GET", "http://deep/api/search?"+tt.urlQuery, nil)
...
func TestQuerierParseSearchRequestTags(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.tags, func(t *testing.T) {
			r := httptest.NewRequest("GET", "http://deep/api/search?tags="+url.QueryEscape(tt.tags), nil)
			fmt.Println("RequestURI:", r.RequestURI)
