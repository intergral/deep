...
func TestCodecMarshallAndUnmarshall_deep_type(t *testing.T) {
	// marshal a deep object using the custom codec
	c := newCodec()
	req1 := &deeppb.TraceByIDRequest{
