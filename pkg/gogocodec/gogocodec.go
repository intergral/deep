...
const (
	frontendProtoGenPkgPath = "github.com/intergral/deep/modules/frontend"
	deepProtoGenPkgPath     = "github.com/intergral/deep/pkg/deeppb"
...
func useGogo(t reflect.Type) bool {
	...
	pkgPath := t.PkgPath()
	return strings.HasPrefix(pkgPath, frontendProtoGenPkgPath) || strings.HasPrefix(pkgPath, deepProtoGenPkgPath) || strings.HasPrefix(pkgPath, jaegerProtoGenPkgPath) || strings.HasPrefix(pkgPath, jaegerModelPkgPath) || strings.HasPrefix(pkgPath, otelProtoPkgPath) || strings.HasPrefix(pkgPath, etcdAPIProtoPkgPath)
}
