...
func (p *Processor) PushSpans(ctx context.Context, req *deeppb.PushSpansRequest) {
...
func (p *Processor) aggregateMetricsForSpan(svcName string, rs *v1.Resource, span *v1_trace.Span) {
	...
	p.spanMetricsDurationSeconds.ObserveWithExemplar(registryLabelValues, latencySeconds, deep_util.TraceIDToHexString(span.TraceId), spanMultiplier)
}
