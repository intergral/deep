...
func batchesToTraces(t *testing.T, batches []*v1.ResourceSpans) ptrace.Traces {
	...
	trace := deeppb.Trace{Batches: batches}
...
func TestDistributor(t *testing.T) {
	for i, tc := range []struct {
		lines            int
		expectedResponse *deeppb.PushResponse
		expectedError    error
	}{
		{
			lines:            10,
...
var _ deeppb.PusherClient = (*mockIngester)(nil)

func (i *mockIngester) PushBytes(ctx context.Context, in *deeppb.PushBytesRequest, opts ...grpc.CallOption) (*deeppb.PushResponse, error) {
	return nil, nil
}

func (i *mockIngester) PushBytesV2(ctx context.Context, in *deeppb.PushBytesRequest, opts ...grpc.CallOption) (*deeppb.PushResponse, error) {
	return nil, nil
}
